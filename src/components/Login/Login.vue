            ...
            <form @submit="login" class="flex flex-column gap-2">
                <div class="field">
                    <span class="p-float-label p-input-icon-right">
                        ...
                        <InputText id="server" name="server" v-model="server" type="text"
                ...
                <div class="field">
                    <span class="p-float-label p-input-icon-right">
                        ...
                        <InputText id="username" name="username" v-model="identity" type="text"
                            :class="{ 'p-invalid': invalidUsername }" aria-describedby="username-error" />
                ...
                <div class="field">
                    <span class="p-float-label">
                        <Password id="password" v-model="password" type="text" :class="{ 'p-invalid': invalidPassword }"
                            :feedback="false" aria-describedby="password-error" toggleMask />
                ...
                <div class="field-checkbox">
                    ...
                    <label for="accept">我已阅读并同意浊莲文明协定</label>
                </div>
